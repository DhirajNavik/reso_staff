...
class _DashBoardScreenState extends State<DashBoardScreen> {
  ...
  @override
  void initState() {
    myAttendanceModelCtrl.inity();
    log(myAttendanceModelCtrl.savedYear.toString());
                              ...
                              child: IntrinsicHeight(
                                child: Column(
                                    ...
                                    children: [
                                      ...
                                      // InkWell(
                                      //   onTap: () {
                                      //     myAttendanceModelCtrl.getLookUpss();
                                      //   },
                                      //   child: Text(myAttendanceModelCtrl
                                      //       .savedYear
                                      //       .toString()),
                                      // ),
                                      SizedBox(height: 10),
                                          ...
                                          SizedBox(
                                            ...
                                            child: DecoratedBox(
                                              ...
                                              child: DropdownButtonFormField<
                                                ...
                                                value: myAttendanceModelCtrl
                                                        .selectedYearr.isEmpty
                                                    ? null
                                                ...
                                                onChanged:
                                                  ...
                                                  if (newValue != null) {
                                                    ...
                                                    //         .getString(
                                                    //             'branchid');
                                                    // log('savedBranchid --> ${naam.toString()}');
                                                  }
                                                },
                                                validator: (value) {
                                                  if (value == null ||
  ...
  Widget attendanceCard(
    ...
    return Card(
      ...
      child: SizedBox(
        ...
        height: time == 'Present' ? height / 3.4 : height / 4.7,
        child: Padding(
    ...
    return Obx(() => badges.Badge(
        ...
        child: Obx(() {
          return attendanceCard(context,
              ...
              //     "1",
              title: myAttendanceModelCtrl.stateMyAttendanceModel.last.data[0].isLatelogin == "1"
                  ? "Late ${Strings.login}"
                  : Strings.login,
              icon: myAttendanceModelCtrl
                  ...
                  ? Icon(Icons.add)
                  : Icon(Icons.info),
              data: myAttendanceModelCtrl.stateMyAttendanceModel.last.data[0].status ==
                      '1'
                  ? "Present"
                  : myAttendanceModelCtrl
