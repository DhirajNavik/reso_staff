                          ...
                          children: [
                            Obx(
                              () => CustomRichText.customRichText(
                                  "${Strings.leaveBl} :",
                                  leaveInfoCtrl!.stateLeaveInfoModel.last.data
                                      .leavebalance
                                      .toString()),
                            ),
                            CustomRichText.customRichText(
                            ...
                            WidgetTextFormField(
                              ...
                              hinttext:
                                  'Enter your purpose for leave ${Strings.filler}',
                              validator: (value) =>
                                  controller.leavesReasonValidation(value),
                              borderRadius:
                                ...
                                children: [
                                  ElevatedButton(
                                    ...
                                    onPressed: () async {
                                      ...
                                      if (formleavesGlobalKey.currentState!
                                              .validate() &&
                                        ...
                                        controller.applyleavesubmit(context);
                                      }
                                    },
                                    child: Text(
                                      "Submit",
