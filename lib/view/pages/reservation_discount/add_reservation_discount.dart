...
class AddReservationDiscountScreen extends StatefulWidget {
  const AddReservationDiscountScreen({super.key});

  @override
  State<AddReservationDiscountScreen> createState() =>
      _AddReservationDiscountScreenState();
}

class _AddReservationDiscountScreenState
    extends State<AddReservationDiscountScreen> {
  ...
  void initState() {
    ...
    log(controllerr.selectedValue.toString() ?? 'hj');
    // controllerr.selectedAddType = 'Student';
    // controllerr.getDropdownListStudent();
    super.initState();
  }
                          ...
                          child: SingleChildScrollView(
                            child: Column(
                              ...
                              children: [
                                ...
                                //         controller.newmaxAmountList[0].count! >
                                //             0
                                //     ? Text(
                                ...
                                controller.selectedValue != null &&
                                        controller.selectedValue!.isNotEmpty &&
                                        controller.newmaxAmountList.isNotEmpty
                                    ? Text(
                                ...
                                WidgetTextFormField(
                                  ...
                                  validator: (value) =>
                                      controller.textFormValidation3(value),
                                ...
                                Row(
                                  ...
                                  children: [
                                    ...
                                    ElevatedButton(
                                      ...
                                      onPressed: () async {
                                        if (reservationkey.currentState!
                                            .validate()) {
                                          controller.sendReservationn(
                                              context: context, from: false);
                                        }
                                      },
                                      child: Text(
                                        "Submit",
...
// controller.selectedadmissiontypeid == '3' ||
//         controller.selectedadmissiontypeid == '1' &&
//             controller.maxAmountList.isNotEmpty
//     ? Text(
//         controller.selectedadmissiontypeid == '3'
//             ? 'Max amount = ${controller.maxAmountList[0].discount} (Available limit is ${controller.maxAmountList[0].availablelimit})'
//             : controller.selectedadmissiontypeid ==
//                     '1'
//                 ? 'Max amount = ${controller.maxAmountList[0].resdiscount} (Available limit is ${controller.maxAmountList[0].availablelimit})'
//                 : '',
// style: TextStyle(
//     fontSize: 10,
//     color:
