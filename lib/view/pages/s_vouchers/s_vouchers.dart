...
import 'package:attendance/view/pages/s_vouchers/add_s_vouchers.dart';
...
class SVouchersScreen extends StatelessWidget {
  const SVouchersScreen({super.key});
                      ...
                      children: [
                        ElevatedButton(
                          ...
                          onPressed: () async {
                            ...
                            Navigator.of(context).push(MaterialPageRoute(
                              builder: (context) => AddSVouchersScreen(),
                            ));
