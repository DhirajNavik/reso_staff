  ...
  Form dialogChild(context, TextEditingController ctrl, int index) {
    return Form(
      ...
      child: Column(
        ...
        children: [
          // Text(
          //     'isLatelogin: ${myAttendanceCtrl.stateMyAttendanceModel.last.data[index].isLatelogin.toString()}'),

          // Text(
          //     'lateLoginReason: ${myAttendanceCtrl.stateMyAttendanceModel.last.data[index].lateLoginReason.toString()}'),
          // Text(
          //     'isEarlyLogout: ${myAttendanceCtrl.stateMyAttendanceModel.last.data[index].isEarlyLogout.toString()}'),
          // Text(
          //     'earlyLogoutReason: ${myAttendanceCtrl.stateMyAttendanceModel.last.data[index].earlyLogoutReason.toString()}'),
          Row(
            children: [
              //----------------------------------*LOGIN CARD
              Expanded(
                child: InkWell(
                  onTap: () {
                    ...
                    log('card index --> ${logStateCtrl.cardIndex.toString()}');
                  },
                  child: Obx(
                    () => attendanceLoginCard(
                      context,
            ...
            () => Visibility(
              ...
              child: Column(
                children: [
                  ...
                  Obx(() => IgnorePointer(
                      ignoring: myAttendanceCtrl.stateMyAttendanceModel.last
                          ...
                          myAttendanceCtrl.stateMyAttendanceModel.last
                                  ...
                                  "null" &&
                              !logStateCtrl.logState.value,
                      child: logStateCtrl.cardIndex == 1 &&
                                  myAttendanceCtrl.stateMyAttendanceModel.last
                                          .data[index].isLatelogin ==
                                      '1' ||
                              logStateCtrl.cardIndex == 2 &&
                          ...
                          ? CustomTextField.textField(
                              ...
                              logStateCtrl.cardIndex == 1 &&
                                  ...
                                  ? "Enter reason"
                                  : logStateCtrl.cardIndex == 1
                                      ? myAttendanceCtrl.stateMyAttendanceModel
                                          .last.data[index].lateLoginReason
                                          .toString()
                                      : myAttendanceCtrl.stateMyAttendanceModel
                                          .last.data[index].earlyLogoutReason
                                          .toString(),
                              enabled: getLastNDates().toString().contains(
                                      myAttendanceCtrl.stateMyAttendanceModel
                                          .last.data[index].date) &&
                                  (logStateCtrl.cardIndex == 1 &&
                                          myAttendanceCtrl
                                                  .stateMyAttendanceModel
                                                  .last
                  ...
                  Visibility(
                      visible: myAttendanceCtrl.stateMyAttendanceModel.last.data[index].lateLoginReason == "null" &&
                              logStateCtrl.logState.value ||
                          myAttendanceCtrl.stateMyAttendanceModel.last.data[index].earlyLogoutReason == "null" &&
                              !logStateCtrl.logState.value,
                      child: getLastNDates().toString().contains(myAttendanceCtrl.stateMyAttendanceModel.last.data[index].date) &&
                                  logStateCtrl.cardIndex == 1 &&
                                  myAttendanceCtrl.stateMyAttendanceModel.last.data[index].isLatelogin ==
                                      '1' &&
                                  myAttendanceCtrl.stateMyAttendanceModel.last.data[index].lateLoginReason ==
                                      'null' ||
                              logStateCtrl.cardIndex == 2 &&
                                  myAttendanceCtrl.stateMyAttendanceModel.last.data[index].isEarlyLogout ==
                                      '1' &&
                                  myAttendanceCtrl.stateMyAttendanceModel.last
                                          .data[index].earlyLogoutReason ==
                                      'null'
                          ...
                          : logStateCtrl.cardIndex == 1 && myAttendanceCtrl.stateMyAttendanceModel.last.data[index].lateLoginReason == '1' ||
                                  logStateCtrl.cardIndex == 2 && myAttendanceCtrl.stateMyAttendanceModel.last.data[index].isEarlyLogout == '1'
                              ? ElevatedButton(
                                  onPressed: null,
                                  child: Text('Submit'),
                                )
