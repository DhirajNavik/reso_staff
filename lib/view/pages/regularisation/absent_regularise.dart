...
import 'package:attendance/view/pages/regularisation/absent_search.dart';
...
class AbsentorOutsideWorkScreen extends StatelessWidget {
  const AbsentorOutsideWorkScreen({super.key});
