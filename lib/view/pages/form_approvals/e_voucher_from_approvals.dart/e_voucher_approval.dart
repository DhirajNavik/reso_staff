...
class EVouchApprovalScreen extends StatelessWidget {
  const EVouchApprovalScreen({super.key});

  @override
  Widget build(BuildContext context) {
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
      var controller = Get.put(EVoucherGetx());
      controller.getEVoucherApprovalList();
    });
    return SafeArea(
      child: Scaffold(
        drawer: CustomDrawer(),
          ...
          builder: (controller) {
            return RefreshIndicator(
              ...
              child: Column(
                ...
                children: [
                  CustomAppBar("E - Voucher Approvals", size: 19.0),
                  // Padding(
                  //   padding:
