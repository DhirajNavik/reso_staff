...
class ResignationHRSearchScreen extends StatefulWidget {
  final String title;
  const ResignationHRSearchScreen({
    super.key,
    required this.title,
  });

  @override
  State<ResignationHRSearchScreen> createState() =>
      _ResignationHRSearchScreenState();
}

class _ResignationHRSearchScreenState extends State<ResignationHRSearchScreen> {
  @override
